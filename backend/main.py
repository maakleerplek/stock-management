...
# Configure CORS
# We use a simple configuration that allows all origins.
# Firefox can be strict about allow_credentials=True with wildcards/regex.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_credentials=False, # We don't use cookie-based auth between frontend and backend
    allow_methods=["*"],
    allow_headers=["*"],
)
